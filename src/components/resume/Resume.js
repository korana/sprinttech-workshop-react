...
const Resume = () => {
  return (
        ...
        <div className="w-full sm:w-1/3 bg-cyan-900">
          ...
          <h2 className="text-2xl text-white pl-10 py-2">
            Full Stack Developer
          </h2>
          <hr className=" ml-10" />
          <h3 className="mt-10 ml-10">
            <AiOutlinePhone className="text-3xl text-white float-left" />
          </h3>
          ...
          <div className="text-2xl font-bold text-white pl-10 mt-10">
            MY PROFILE
          </div>
        ...
        <div className="w-full sm:w-2/3 bg-cyan-50">
          <h6 className="text-2xl bg-cyan-900 text-white mx-8 mt-20 pl-3 py-1">
            WORK EXPERIENCE
          </h6>
          <p className="mt-5 ml-8 text-xl text-cyan-900 font-bold">
            2002 - 2022
          </p>
          <p className="mt-2 ml-8 text-xl text-black font-bold">
            PROJECT MANAGER
          </p>
          <h6 className="text-2xl bg-cyan-900 text-white mt-20 mx-8 pl-3 py-1">
            EDUCATION
          </h6>
          <p className="ml-8 text-xl mt-5 text-cyan-900 font-bold">
            PRIMARY SCHOOL
          </p>
          ...
          <p className="mt-2 ml-8 text-xl text-black">
          ...
          <p className="mt-2 ml-8 text-xl text-black">
            Name: SRINAKARINWIROTE UNIVERSITY
          </p>
          <h6 className="text-2xl bg-cyan-900 text-white mt-20 mx-8 pl-3 py-1">
            QUALIFICATION
          </h6>
